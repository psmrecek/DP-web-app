      ...
      "elements": [
        {
          ...
          "name": "instructions_1",
          "state": "expanded",
          "html": "<h3>Welcome to the Questionnaire</h3><div style=\"max-width: 40vw; padding-top: 15px;\"><font size=\"4\" color=\"#FF0000\">Please <b>watch</b> the instruction video. <b>Click [Next] after you watch the video.</b><br></font><font size=\"4\" color=\"#FF0000\"><b>Do not click the yellow [Done] button at the top until you have finished the whole survey.</b></font></div><div style=\"padding-top: 30px; display: flex; justify-content: center; align-items: center;\"><iframe style=\"width: calc(40vw - 50px - 67.2px); height: calc((40vw - 50px - 67.2px) / 1.77777778);\" src=\"https://www.youtube.com/embed/ujYdLMsxaSU?&amp;controls=0&amp;cc_load_policy=1&amp;modestbranding=1\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></div>"
        }
      ]
    },
      ...
      "elements": [
        {
          "type": "html",
          "name": "instructions_2",
          "html": "<h3>Verbal Elaboration (1/5)</h3><div style=\"max-width: 40vw; padding-top: 15px;\"><font size=\"4\" color=\"#FF0000\">Please <b>watch</b> the instruction video. <b>Click [Next] after you watch the video.</b><br></font><font size=\"4\" color=\"#FF0000\"><b>Do not click the yellow [Done] button at the top until you have finished the whole survey.</b></font></div><div style=\"padding-top: 30px; display: flex; justify-content: center; align-items: center;\"><iframe style=\"width: calc(40vw - 50px - 67.2px); height: calc((40vw - 50px - 67.2px) / 1.77777778);\" src=\"https://www.youtube.com/embed/gFLx9sV0QSc?&amp;controls=0&amp;cc_load_policy=1&amp;modestbranding=1\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></div>"
        }
      ],
      "readOnly": true
    },
      ...
      "elements": [
        {
          "type": "html",
          "name": "instructions_7",
          "html": "<h3>You're Almost There! Final Task Ahead</h3><div style=\"max-width: 40vw; padding-top: 15px;\"><font size=\"4\" color=\"#FF0000\">Please <b>watch</b> the instruction video. <b>Click [Next] after you watch the video.</b><br></font><font size=\"4\" color=\"#FF0000\"><b>Do not click the yellow [Done] button at the top until you have finished the whole survey.</b></font></div><div style=\"padding-top: 30px; display: flex; justify-content: center; align-items: center;\"><iframe style=\"width: calc(40vw - 50px - 67.2px); height: calc((40vw - 50px - 67.2px) / 1.77777778);\" src=\"https://www.youtube.com/embed/v6KLRAIN-NA?&amp;controls=0&amp;cc_load_policy=1&amp;modestbranding=1\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe></div>"
        }
      ],
      "readOnly": true
    },
      ...
      "elements": [
        {
          "type": "html",
          "name": "instructions_8",
          "html": "<h3>Final Task</h3><p><font size=\"4\">As a final step, we need your assistance to ensure the <b>accuracy and reliability</b> of the responses you've provided.<br><br>It is critical that you <b>now always</b> choose honestly whether each answer is a Lie, a Half-truth, or a Truth.<br><br></font></p>"
        },
        {
          "type": "matrixdropdown",
...
// Iterate over the pages and print page names
for (var i = 0; i < json_fg.pages.length; i++) {
    // If page has a title in elements, print it. If not, print the html from elements.
    if (json_fg.pages[i].elements[0].title) {
        console.log('"' + json_fg.pages[i].name + '": ' + '"' + json_fg.pages[i].elements[0].title + '",');
    } else {
        html = json_fg.pages[i].elements[0].html;
        // Get text only from the first html tag
        html = html.replace(/<[^>]*>/g, '');
        console.log('"' + json_fg.pages[i].name + '": ' + '"' + html + '",');
    }
}